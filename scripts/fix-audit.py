#!/usr/bin/env python3
"""Apply specific audit fixes to the reconciliation CSV."""
import csv
import json
import sys
...
for i, row in enumerate(rows):
    ...
    # Xero invoices -> 406 Bookkeeping
    if "XERO AU INV-" in payee and row.get("AccountCode") == "495":
        row["AccountCode"] = "406"
        row["AccountName"] = accounts.get("406", "")
        fixes.append(f"L{line}: Xero invoice -> 406 Bookkeeping")
...
print(json.dumps({"ok": True, "fixes": fixes, "uploaded": True}, indent=2))
